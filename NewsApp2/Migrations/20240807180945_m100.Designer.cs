            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "0d9e9423-3a1d-415b-aae7-504e3d660b42",
                            ConcurrencyStamp = "56913a40-8534-46d6-92a3-f980e1be3b45",
                            Name = "Prog",
                            NormalizedName = "PROG"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "591f07e2-cf1d-44bb-8170-e2fb71236832",
                            RoleId = "0d9e9423-3a1d-415b-aae7-504e3d660b42"
                        });
                });
            ...
            modelBuilder.Entity("NewsApp2.Models.Entities.Contact", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1e649d00-c6dd-41f3-b90c-0e741931c50f"),
                            Created = new DateTime(2024, 8, 7, 20, 9, 44, 826, DateTimeKind.Local).AddTicks(8042),
            ...
            modelBuilder.Entity("NewsApp2.Models.Entities.SiteInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("67573336-7858-41f1-8698-4b0d9b002edb"),
                            ...
                            Activity = "News site",
                            Created = new DateTime(2024, 8, 7, 20, 9, 44, 826, DateTimeKind.Local).AddTicks(7885),
                            Name = "Worldwide"
                        });
                });
            ...
            modelBuilder.Entity("NewsApp2.Models.Entities.SiteState", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f39c0e9b-2093-4479-933d-9483e0529407"),
                            ClosingMessage = "The site is temporarily closed for development",
                            Created = new DateTime(2024, 8, 7, 20, 9, 44, 826, DateTimeKind.Local).AddTicks(8062),
                            State = true
                        });
                });
            ...
            modelBuilder.Entity("NewsApp2.Models.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "591f07e2-cf1d-44bb-8170-e2fb71236832",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e0e795fa-5a8d-4032-9a1e-abfe0593eb5d",
                            Email = "Programmer@Gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = true,
                            NormalizedEmail = "PROGRAMMER@GMAIL.COM",
                            NormalizedUserName = "PROGRAMMER@GMAIL.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEAY6NwDSqH62O9fdOEeDl4Dl39seb4f4W2kGkadt9jEtJZALNRozMEzQWR1EtMIqKw==",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "87ba089e-bdb4-4822-b289-efecc036c6dc",
                            TwoFactorEnabled = false,
                            UserName = "Programmer@Gmail.com",
                            Age = 0,
                            CreatedDate = new DateTime(2024, 8, 7, 18, 9, 44, 826, DateTimeKind.Utc).AddTicks(8295)
                        });
                });
