...
namespace NewsApp2.Controllers
{
    ...
    //[Authorize(Roles = "Admin")] // السماح بصلاحية وصول واحدة
    [Authorize(Roles = "Admin,Prog,Employee")]
    //-----------السماح بكلا الصلاحيتين-----------
    ...
    public class AdminController : Controller
    {
        ...
        {
            ViewBag.sectionCount = await _section.Entity.GetAll().CountAsync();
            ViewBag.newsCount = await _news.Entity.GetAll().CountAsync();

            return View();
        }
        public JsonResult NewsSectionsChart()
        {
            var data1 = _news.Entity.GetAll().Include(s => s.Sections)
